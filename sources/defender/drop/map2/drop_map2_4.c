...
void find_pos_tower3_4_3(defender_t *dfnd)
{
...
void find_pos_tower3_4_2(defender_t *dfnd)
{
    ...
    find_pos_tower3_4_3(dfnd);
}

void find_pos_tower3_4_1(defender_t *dfnd)
{
