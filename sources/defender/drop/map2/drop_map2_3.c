...
void find_pos_tower3_3_3(defender_t *dfnd)
{
...
void find_pos_tower3_3_2(defender_t *dfnd)
{
    ...
    find_pos_tower3_3_3(dfnd);
}

void find_pos_tower3_3_1(defender_t *dfnd)
{
