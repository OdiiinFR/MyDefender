...
void find_pos_tower3_1_3(defender_t *dfnd)
{
...
void find_pos_tower3_1_2(defender_t *dfnd)
{
    ...
    find_pos_tower3_1_3(dfnd);
}

void find_pos_tower3_1_1(defender_t *dfnd)
{
