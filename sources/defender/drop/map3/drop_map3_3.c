...
void find_pos_tower4_3_3(defender_t *dfnd)
{
    ...
    if (dfnd->drop.x > 1250 && dfnd->drop.x < 1366 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[6] = 0;
        dfnd->all.t7 = new_tower(3, "images/tower/tower3_1.png", pos1, dfnd);
    }
    if (dfnd->drop.x > 1500 && dfnd->drop.x < 1616 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[7] = 0;
        dfnd->all.t8 = new_tower(3, "images/tower/tower3_1.png", pos2, dfnd);
    }
}

void find_pos_tower4_3_2(defender_t *dfnd)
{
    ...
    find_pos_tower4_3_3(dfnd);
}

void find_pos_tower4_3_1(defender_t *dfnd)
{
