...
void find_pos_tower4_1_3(defender_t *dfnd)
{
    ...
    if (dfnd->drop.x > 1250 && dfnd->drop.x < 1366 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[6] = 0;
        dfnd->all.t7 = new_tower(1, "images/tower/tower1_1.png", pos1, dfnd);
    }
    if (dfnd->drop.x > 1500 && dfnd->drop.x < 1616 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[7] = 0;
        dfnd->all.t8 = new_tower(1, "images/tower/tower1_1.png", pos2, dfnd);
    }
}

void find_pos_tower4_1_2(defender_t *dfnd)
{
    ...
    if (dfnd->drop.x > 855 && dfnd->drop.x < 971 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[4] = 0;
        dfnd->all.t5 = new_tower(1, "images/tower/tower1_1.png", pos1, dfnd);
    }
    if (dfnd->drop.x > 680 && dfnd->drop.x < 796 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[5] = 0;
        dfnd->all.t6 = new_tower(1, "images/tower/tower1_1.png", pos2, dfnd);
    }
    find_pos_tower4_1_3(dfnd);
}

void find_pos_tower4_1_1(defender_t *dfnd)
{
    ...
    if (dfnd->drop.x > 820 && dfnd->drop.x < 936 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[2] = 0;
        dfnd->all.t3 = new_tower(1, "images/tower/tower1_1.png", pos1, dfnd);
    }
    if (dfnd->drop.x > 1060 && dfnd->drop.x < 1176 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[3] = 0;
        dfnd->all.t4 = new_tower(1, "images/tower/tower1_1.png", pos2, dfnd);
    }
    find_pos_tower4_1_2(dfnd);
}
...
void find_pos_tower4_1(defender_t *dfnd)
{
    ...
    if (dfnd->drop.x > 60 && dfnd->drop.x < 176 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[0] = 0;
        dfnd->all.t1 = new_tower(1, "images/tower/tower1_1.png", pos1, dfnd);
    }
    if (dfnd->drop.x > 270 && dfnd->drop.x < 386 &&
        ...
        dfnd->drop.y = 0;
        dfnd->towers[1] = 0;
        dfnd->all.t2 = new_tower(1, "images/tower/tower1_1.png", pos2, dfnd);
    }
    find_pos_tower4_1_1(dfnd);
}
